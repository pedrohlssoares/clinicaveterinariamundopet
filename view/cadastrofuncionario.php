...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-light" style="color: var(--pet-green);">🐾 Novo Funcionário</h2>
        <a href="gerenciafuncionario.php" class="btn btn-outline-secondary shadow-sm">
            <i class="bi bi-list"></i> Ver Funcionários Cadastrados
        </a>
    </div>
            ...
            <form method="post" action="../controller/funcionariocontroller.php">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-5 px-4">
                        ...
                        <div class="mb-3"><input type="text" class="form-control custom-input" name="cpf" placeholder="CPF"></div>
                        <div class="mb-3"><input type="text" class="form-control custom-input" name="salario" placeholder="Salário"></div>
                    </div>
